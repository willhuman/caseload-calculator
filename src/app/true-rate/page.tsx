          ...
          <div className="flex justify-between items-center">
            <span className="text-gray-600 flex items-center gap-1">
              ...
              <span className="relative group">
                ...
                <span className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-3 py-2 bg-nesso-navy text-white text-xs rounded-lg opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none w-56 text-left z-10 shadow-lg">
                  Self-employment tax covers Social Security (12.4%) and Medicare (2.9%) that W-2 employees split with their employer. When you're self-employed, you pay both portions.
